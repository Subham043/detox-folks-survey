                                                                                ...
                                                                                <td>
                                                                                    <table class="table align-middle table-nowrap mb-0">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="width: 33%">
                                                                                                    <select onchange="week_change_handler(event)" class="form-control" name="pp_week_200_g" id="pp_week_200_g">
                                                                                                        @for($i = 0; $i <= 10000; $i+=200)
                                                                                                        <option value="{{$i}}" {{ old('pp_week_200_g')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                        @endfor
                                                                                                    </select>
                                                                                                    @error('pp_week_200_g')
                                                                                                        <div class="invalid-message">{{ $message }}</div>
                                                                                                ...
                                                                                                <td style="width: 33%">
                                                                                                    <select onchange="month_change_handler(event)" class="form-control" name="pp_month_200_g" id="pp_month_200_g">
                                                                                                        @for($i = 0; $i <= 40000; $i+=(200*4))
                                                                                                        <option value="{{$i}}" {{ old('pp_month_200_g')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                        @endfor
                                                                                                    </select>
                                                                                                ...
                                                                                                <td style="width: 33%">
                                                                                                    <input class="form-control" type="number" name="pp_price_200_g" id="pp_price_200_g" value="{{old('pp_price_200_g')}}">
                                                                                ...
                                                                                <td>
                                                                                    <table class="table align-middle table-nowrap mb-0">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="width: 33%">
                                                                                                    <select onchange="week_change_handler(event)" class="form-control" name="pp_week_300_g" id="pp_week_300_g">
                                                                                                        @for($i = 0; $i <= 10000; $i+=200)
                                                                                                        <option value="{{$i}}" {{ old('pp_week_300_g')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                        @endfor
                                                                                                    </select>
                                                                                                    @error('pp_week_300_g')
                                                                                                        <div class="invalid-message">{{ $message }}</div>
                                                                                                ...
                                                                                                <td style="width: 33%">
                                                                                                    <select onchange="month_change_handler(event)" class="form-control" name="pp_month_300_g" id="pp_month_300_g">
                                                                                                        @for($i = 0; $i <= 40000; $i+=(200*4))
                                                                                                        <option value="{{$i}}" {{ old('pp_month_300_g')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                        @endfor
                                                                                                    </select>
                                                                                                ...
                                                                                                <td style="width: 33%">
                                                                                                    <input class="form-control" type="number" name="pp_price_300_g" id="pp_price_300_g" value="{{old('pp_price_300_g')}}">
                                                                                ...
                                                                                <td>
                                                                                    <table class="table align-middle table-nowrap mb-0">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="width: 33%">
                                                                                                    <select onchange="week_change_handler(event)" class="form-control" name="pp_week_500_g" id="pp_week_500_g">
                                                                                                        @for($i = 0; $i <= 10000; $i+=200)
                                                                                                        <option value="{{$i}}" {{ old('pp_week_500_g')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                        @endfor
                                                                                                    </select>
                                                                                                    @error('pp_week_500_g')
                                                                                                        <div class="invalid-message">{{ $message }}</div>
                                                                                                ...
                                                                                                <td style="width: 33%">
                                                                                                    <select onchange="month_change_handler(event)" class="form-control" name="pp_month_500_g" id="pp_month_500_g">
                                                                                                        @for($i = 0; $i <= 40000; $i+=(200*4))
                                                                                                        <option value="{{$i}}" {{ old('pp_month_500_g')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                        @endfor
                                                                                                    </select>
                                                                                                ...
                                                                                                <td style="width: 33%">
                                                                                                    <input class="form-control" type="number" name="pp_price_500_g" id="pp_price_500_g" value="{{old('pp_price_500_g')}}">
                                                                                ...
                                                                                <td>
                                                                                    <table class="table align-middle table-nowrap mb-0">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="width: 33%">
                                                                                                    <select onchange="week_change_handler(event)" class="form-control" name="pp_week_750_flat" id="pp_week_750_flat">
                                                                                                        @for($i = 0; $i <= 10000; $i+=200)
                                                                                                        <option value="{{$i}}" {{ old('pp_week_750_flat')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                        @endfor
                                                                                                    </select>
                                                                                                ...
                                                                                                <td style="width: 33%">
                                                                                                    <select onchange="month_change_handler(event)" class="form-control" name="pp_month_750_flat" id="pp_month_750_flat">
                                                                                                        @for($i = 0; $i <= 40000; $i+=(200*4))
                                                                                                        <option value="{{$i}}" {{ old('pp_month_750_flat')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                        @endfor
                                                                                                    </select>
                                                                                                ...
                                                                                                <td style="width: 33%">
                                                                                                    <input class="form-control" type="number" name="pp_price_750_flat" id="pp_price_750_flat" value="{{old('pp_price_750_flat')}}">
                                                                                    ...
                                                                                    <td>
                                                                                        <table class="table align-middle table-nowrap mb-0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td style="width: 33%">
                                                                                                        <select onchange="week_change_handler(event)" class="form-control" name="p_bag_week_xx_large" id="p_bag_week_xx_large">
                                                                                                            @for($i = 0; $i <= 30; $i+=5)
                                                                                                            <option value="{{$i}}" {{ old('p_bag_week_xx_large')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                            @endfor
                                                                                                        </select>
                                                                                                    ...
                                                                                                    <td style="width: 33%">
                                                                                                        <select onchange="month_change_handler(event)" class="form-control" name="p_bag_month_xx_large" id="p_bag_month_xx_large">
                                                                                                            @for($i = 0; $i <= 120; $i+=(5*4))
                                                                                                            <option value="{{$i}}" {{ old('p_bag_month_xx_large')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                            @endfor
                                                                                                        </select>
                                                                                                    ...
                                                                                                    <td style="width: 33%">
                                                                                                        <input class="form-control" type="number" name="p_bag_price_xx_large" id="p_bag_price_xx_large" value="{{old('p_bag_price_xx_large')}}">
                                                                                    ...
                                                                                    <td>
                                                                                        <table class="table align-middle table-nowrap mb-0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td style="width: 33%">
                                                                                                        <select onchange="week_change_handler(event)" class="form-control" name="cloth_bag_week_small" id="cloth_bag_week_small">
                                                                                                            @for($i = 0; $i <= 1000; $i+=5)
                                                                                                            <option value="{{$i}}" {{ old('cloth_bag_week_small')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                            @endfor
                                                                                                        </select>
                                                                                                    ...
                                                                                                    <td style="width: 33%">
                                                                                                        <select onchange="month_change_handler(event)" class="form-control" name="cloth_bag_month_small" id="cloth_bag_month_small">
                                                                                                            @for($i = 0; $i <= 4000; $i+=(5*4))
                                                                                                            <option value="{{$i}}" {{ old('cloth_bag_month_small')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                            @endfor
                                                                                                        </select>
                                                                                                    ...
                                                                                                    <td style="width: 33%">
                                                                                                        <input class="form-control" type="number" name="cloth_bag_price_small" id="cloth_bag_price_small" value="{{old('cloth_bag_price_small')}}">
                                                                                    ...
                                                                                    <td>
                                                                                        <table class="table align-middle table-nowrap mb-0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td style="width: 33%">
                                                                                                        <select onchange="week_change_handler(event)" class="form-control" name="cloth_bag_week_medium" id="cloth_bag_week_medium">
                                                                                                            @for($i = 0; $i <= 1000; $i+=5)
                                                                                                            <option value="{{$i}}" {{ old('cloth_bag_week_medium')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                            @endfor
                                                                                                        </select>
                                                                                                    ...
                                                                                                    <td style="width: 33%">
                                                                                                        <select onchange="month_change_handler(event)" class="form-control" name="cloth_bag_month_medium" id="cloth_bag_month_medium">
                                                                                                            @for($i = 0; $i <= 4000; $i+=(5*4))
                                                                                                            <option value="{{$i}}" {{ old('cloth_bag_month_medium')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                            @endfor
                                                                                                        </select>
                                                                                                    ...
                                                                                                    <td style="width: 33%">
                                                                                                        <input class="form-control" type="number" name="cloth_bag_price_medium" id="cloth_bag_price_medium" value="{{old('cloth_bag_price_medium')}}">
                                                                                    ...
                                                                                    <td>
                                                                                        <table class="table align-middle table-nowrap mb-0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td style="width: 33%">
                                                                                                        <select onchange="week_change_handler(event)" class="form-control" name="cloth_bag_week_large" id="cloth_bag_week_large">
                                                                                                            @for($i = 0; $i <= 1000; $i+=5)
                                                                                                            <option value="{{$i}}" {{ old('cloth_bag_week_large')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                            @endfor
                                                                                                        </select>
                                                                                                    ...
                                                                                                    <td style="width: 33%">
                                                                                                        <select onchange="month_change_handler(event)" class="form-control" name="cloth_bag_month_large" id="cloth_bag_month_large">
                                                                                                            @for($i = 0; $i <= 4000; $i+=(5*4))
                                                                                                            <option value="{{$i}}" {{ old('cloth_bag_month_large')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                            @endfor
                                                                                                        </select>
                                                                                                    ...
                                                                                                    <td style="width: 33%">
                                                                                                        <input class="form-control" type="number" name="cloth_bag_price_large" id="cloth_bag_price_large" value="{{old('cloth_bag_price_large')}}">
                                                                                    ...
                                                                                    <td>
                                                                                        <table class="table align-middle table-nowrap mb-0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td style="width: 33%">
                                                                                                        <select onchange="week_change_handler(event)" class="form-control" name="paper_straw_week_6mm" id="paper_straw_week_6mm">
                                                                                                            @for($i = 0; $i <= 30; $i+=5)
                                                                                                            <option value="{{$i}}" {{ old('paper_straw_week_6mm')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                            @endfor
                                                                                                        </select>
                                                                                                    ...
                                                                                                    <td style="width: 33%">
                                                                                                        <select onchange="month_change_handler(event)" class="form-control" name="paper_straw_month_6mm" id="paper_straw_month_6mm">
                                                                                                            @for($i = 0; $i <= 120; $i+=(5*4))
                                                                                                            <option value="{{$i}}" {{ old('paper_straw_month_6mm')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                            @endfor
                                                                                                        </select>
                                                                                                    ...
                                                                                                    <td style="width: 33%">
                                                                                                        <input class="form-control" type="number" name="paper_straw_price_6mm" id="paper_straw_price_6mm" value="{{old('paper_straw_price_6mm')}}">
                                                                                    ...
                                                                                    <td>
                                                                                        <table class="table align-middle table-nowrap mb-0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td style="width: 33%">
                                                                                                        <select onchange="week_change_handler(event)" class="form-control" name="paper_straw_week_8mm" id="paper_straw_week_8mm">
                                                                                                            @for($i = 0; $i <= 30; $i+=5)
                                                                                                            <option value="{{$i}}" {{ old('paper_straw_week_8mm')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                            @endfor
                                                                                                        </select>
                                                                                                    ...
                                                                                                    <td style="width: 33%">
                                                                                                        <select onchange="month_change_handler(event)" class="form-control" name="paper_straw_month_8mm" id="paper_straw_month_8mm">
                                                                                                            @for($i = 0; $i <= 120; $i+=(5*4))
                                                                                                            <option value="{{$i}}" {{ old('paper_straw_month_8mm')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                            @endfor
                                                                                                        </select>
                                                                                                    ...
                                                                                                    <td style="width: 33%">
                                                                                                        <input class="form-control" type="number" name="paper_straw_price_8mm" id="paper_straw_price_8mm" value="{{old('paper_straw_price_8mm')}}">
                                                                                  ...
                                                                                  <td>
                                                                                      <table class="table align-middle table-nowrap mb-0">
                                                                                          <tbody>
                                                                                              <tr>
                                                                                                  <td style="width: 33%">
                                                                                                      <select onchange="week_change_handler(event)" class="form-control" name="parcel_paper_week_15" id="parcel_paper_week_15">
                                                                                                          @for($i = 0; $i <= 50; $i+=5)
                                                                                                          <option value="{{$i}}" {{ old('parcel_paper_week_15')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                          @endfor
                                                                                                      </select>
                                                                                                  ...
                                                                                                  <td style="width: 33%">
                                                                                                      <select onchange="month_change_handler(event)" class="form-control" name="parcel_paper_month_15" id="parcel_paper_month_15">
                                                                                                          @for($i = 0; $i <= 200; $i+=(5*4))
                                                                                                          <option value="{{$i}}" {{ old('parcel_paper_month_15')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                          @endfor
                                                                                                      </select>
                                                                                                  ...
                                                                                                  <td style="width: 33%">
                                                                                                      <input class="form-control" type="number" name="parcel_paper_price_15" id="parcel_paper_price_15" value="{{old('parcel_paper_price_15')}}">
                                                              ...
                                                              <div class="accordion-body">
                                                                  <div class="table-responsive">
                                                                      <table class="table table-bordered align-middle table-nowrap table-striped-columns mb-0">
                                                                          ...
                                                                          <tbody>
                                                                              <tr>
                                                                                  <td><a href="#" class="fw-medium text-center">Pack of 12</a></td>
                                                                                  <td>
                                                                                      <table class="table align-middle table-nowrap mb-0">
                                                                                          <tbody>
                                                                                              <tr>
                                                                                                  <td style="width: 33%">
                                                                                                      <select onchange="week_change_handler(event)" class="form-control" name="toothpick_week_12" id="toothpick_week_12">
                                                                                                          @for($i = 0; $i <= 5; $i+=1)
                                                                                                          <option value="{{$i}}" {{ old('toothpick_week_12')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                          @endfor
                                                                                                      </select>
                                                                                                  ...
                                                                                                  <td style="width: 33%">
                                                                                                      <select onchange="month_change_handler(event)" class="form-control" name="toothpick_month_12" id="toothpick_month_12">
                                                                                                          @for($i = 0; $i <= 20; $i+=(1*4))
                                                                                                          <option value="{{$i}}" {{ old('toothpick_month_12')==$i ? 'selected' : '' }}>{{$i}}</option>
                                                                                                          @endfor
                                                                                                      </select>
                                                                                                  ...
                                                                                                  <td style="width: 33%">
                                                                                                      <input class="form-control" type="number" name="toothpick_price_12" id="toothpick_price_12" value="{{old('toothpick_price_12')}}">
